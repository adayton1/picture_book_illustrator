...
ILLUSTRATOR_PYTHONPATH ?= $PYTHONPATH:$(CURDIR):$(ILLUSTRATOR_TENSORFLOW_MODEL_DIR):$(ILLUSTRATOR_TENSORFLOW_MODEL_DIR)/research/im2txt:$(ILLUSTRATOR_TENSORFLOW_MODEL_DIR)/research/slim
