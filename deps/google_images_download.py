# Taken from https://github.com/adayton1/google-images-download
...
args_list = [
    ...
    "limit", "related_images", "format", "color", "color_type", "usage_rights",
    "size", "aspect_ratio", "type", "time", "time_range", "delay", "url",
    "single_image", "output_directory", "proxy", "similar_images",
    "specific_site", "print_urls", "print_size", "metadata",
    "extract_metadata", "socket_timeout", "thumbnail", "language", "prefix",
    "chromedriver"
]
    ...
    if object_check['config_file'] != '':
        ...
        parser.add_argument(
            ...
            choices=[
                ...
                'Icelandic', 'Italian', 'Japanese', 'Korean', 'Latvian',
                'Lithuanian', 'Norwegian', 'Portuguese', 'Polish', 'Romanian',
    ...
    def build_search_url(self, search_term, params, url, similar_images,
        ...
        if url:
            ...
            url = 'https://www.google.com/search?q=' + quote(
                search_term
            ) + '&as_sitesearch=' + specific_site + '&espv=2&biw=1366&bih=667&site=webhp&source=lnms&tbm=isch' + params + '&sa=X&ei=XosDVaCXD8TasATItgE&ved=0CAcQ_AUoAg'
        else:
            url = 'https://www.google.com/search?q=' + quote(
                search_term
    ...
    def download_image_thumbnail(self, image_url, main_directory, dir_name,
        ...
        try:
            ...
            try:
                ...
                download_status = 'fail'
                download_message = "UnicodeEncodeError on an image...trying next one..." + " Error: " + str(
                    e)

        except HTTPError as e:  # If there is any HTTPError
            download_status = 'fail'
            download_message = "HTTPError on an image...trying next one..." + " Error: " + str(
                e)

        except URLError as e:
            download_status = 'fail'
            download_message = "URLError on an image...trying next one..." + " Error: " + str(
                e)

        except ssl.CertificateError as e:
            download_status = 'fail'
            download_message = "CertificateError on an image...trying next one..." + " Error: " + str(
                e)
    ...
    def download_image(self, image_url, image_format, main_directory, dir_name,
        ...
        try:
            ...
            try:
                ...
                path = main_directory + "/" + dir_name + "/" + prefix + str(
                    count) + ". " + image_name
                ...
                download_status = 'success'
                download_message = "Completed Image ====> " + prefix + str(
                    count) + ". " + image_name
    ...
    def _get_all_items(self, page, main_directory, dir_name, limit, arguments):
        ...
        while count < limit + 1:
            ...
            if object == "no_links":
                ...
                #download the images
                download_status, download_message, return_image_name = self.download_image(
                    object['image_link'], object['image_format'],
                    main_directory, dir_name, count, arguments['print_urls'],
                    arguments['socket_timeout'], arguments['prefix'],
            ...
            for sky in suffix_keywords:  # 1.for every suffix keywords
                ...
                while i < len(search_keyword):  # 2.for every main keyword
                    ...
                    url = self.build_search_url(
                        search_term, params, arguments['url'],
                    ...
                    items, errorCount = self._get_all_items(
                    ...
                    if arguments['extract_metadata']:
                        try:
                            ...
                            print(e)
                        text_file = open("logs/" + search_keyword[i] + ".txt",
                                         "w")
                        text_file.write(
